...
class PaymentService
{
    ...
    public function initiate(
        ...
        if ($existing) {
            return [
                ...
                'payment_url' => "https://mediraai.com/pg?token={$existing->token}" ,
        ...
        try {
            ...
            return [
                ...
                'payment_url' => "https://mediraai.com/pg?token={$result['token']}",
                'res_num'     => $resNum,
            ];
    ...
    public function handleCallback(array $payload): array
    {
        ...
        if (! $this->gateway->isCallbackSuccessful($state)) {
            ...
            if ( $order &&(int) $order->reason_id === 5 && !empty($order->reason_ref)) {
