...
Route::prefix('pharmacy')->name('pharmacy.')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'user.active', 'role:pharmacy', 'ownership:pharmacy'])->group(function () {
        Route::get('/finance', [PharmacyProfileController::class, 'finance']);
...
Route::prefix('lab')->name('lab.')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'user.active', 'role:lab', 'ownership:lab'])->group(function () {
        ...
        Route::get('/lab/prescription-file/{id}/{fileName}', [LabRequestController::class, 'downloadPatientPrescription'])->name('prescription.download');
